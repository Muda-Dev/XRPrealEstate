    ...
    def make_transfer(self, request):
        try:
            ...
            # Assuming this means EVM
                    ...
                    hash_value =  evc.make_contract_token_transfer(os.getenv("address"), merchant_address,sending_amount ,account_number)
...
def get_service(service_id, chain):
    ...
    data = response.json()
    for x in data:
        if x.get('service_id') == service_id:
            return x
    return {}
